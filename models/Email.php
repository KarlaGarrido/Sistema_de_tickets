...
class Email extends PHPMailer{
    ...
    protected $gCorreo = 'soporte.cruz@outlook.com';
    protected $gContrasena = '@G4rr1d01234';
    ...
    public function ticket_abierto($tick_id){
        ...
        foreach ($datos as $row){
            ...
            $correo = $row["usu_correo"]; //disparar el correo a quien le debe de llegar
        }
        ...
        $this->From = $this->gCorreo; // de donde viene
        $this->SMTPSecure = 'tls';
