...
$(document).ready(function(){
    ...
    if (rol_id==1){ // en base al rol en este caso 
    ...
    }else{// lo que esta arriba de la tabla, cuando seleccionas para imprimir la tabla en sus diferentes formatos
        tabla=$('#ticket_data').dataTable({
            "aProcessing": true,
            "aServerSide": true,
            dom: 'Bfrtip',
            ...
            "ajax":{            //la captutra de los datos de la base de datos a la tabla
...
// para redirigir al detalle de ticket
...
// para el cambio de estatus de la asignacion
function guardar(e){
    e.preventDefault();
...
// esto es para el boton de cambiar estado
